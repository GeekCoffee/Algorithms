...
/**
 * array实现的并查集-版本4的UnionFind， date = 29/5 2019 ,  author = chensheng
 *  是在版本3-UnionFind的基础上，优化了Union时候的操作
 *  => 优化点：合并之前判断一个哪个树层数更小，不是以哪个树的节点更少来判断了
 *  => 这样的并查集所表示的树就可以避免退化成为非常高非常深的多叉树
